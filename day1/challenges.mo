actor {
    ...
    // dfx canister call bc23 multiply '(2, 3)'
    // Should give: (6 : nat)
    ...
    // dfx canister call bc23 volume '(4)'
    // Should give: (64 : nat)
    ...
    // dfx canister call bc23 hours_to_minutes '(10)'
    // Should give: (600 : nat)
    ...
    // dfx canister call bc23 set_counter '(5)'
    // Should set the counter to: 5
    public func set_counter(n : Nat) : async () {
        counter := n;
    };

    // dfx canister call bc23 get_counter
    // Should give: (5 : nat)
    ...
    // dfx canister call bc23 test_divide '(2, 10)'
    // Should give: true
    // dfx canister call bc23 test_divide '(3, 10)'
    // Should give: false
    ...
    // dfx canister call bc23 is_even '(12)'
    // Should give: true
    // dfx canister call bc23 is_even '(17)'
    // Should give: false
