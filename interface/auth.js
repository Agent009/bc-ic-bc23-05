...
import { isAuthenticated, accountId, principal, principalId, authSessionData, totalSupply, bc2305Actor, bc2305CanisterId, HOST } from "./stores"
import { transferFee, proposalVoteThreshold, proposalSubmissionDeposit } from "./stores"
import { getSystemParams } from "./lib"
import { idlFactory as idlFactoryBC2305 } from "../src/declarations/bc2305/bc2305.did.js"
import { Actor, HttpAgent } from "@dfinity/agent";

//region Plug Wallet Auth
const whitelist = [bc2305CanisterId];
...
export async function login() {
  ...
  const bc2305 = Actor.createActor(idlFactoryBC2305, {
    agent,
    canisterId: bc2305CanisterId,
  });

  /*const bc2305 = await window.ic.plug.createActor({
    canisterId: bc2305CanisterId,
    interfaceFactory: idlFactoryBC2305,
  })*/
  ...
  // let systemParams = await getSystemParams(bc2305);
}
